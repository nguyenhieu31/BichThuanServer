...
public interface OrderRepository extends JpaRepository<Order, Long>{
    ...
    @Query("""
    SELECT new com.shopproject.shopbt.dto.OrdersDTO(o.orderId, o.status, u.fullName, o.address, p.image, p.name, ot.pricePerUnit, ot.quantity, ot.size, ot.color, o.phonePersonOrder, o.personNote)
    FROM Order o
